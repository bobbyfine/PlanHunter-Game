...
_path_inject(['/Users/Bobby/Google Drive/Personal Project/Python/PlanHunter Game'])
...
DEFAULT_SCRIPT='/Users/Bobby/Google Drive/Personal Project/Python/PlanHunter Game/main.py'
SCRIPT_MAP={}
try:
    _run()
